...
const (
	...
	collectionNamePrefix = "commodity_"
...
type Model struct {
	...
	// 基本的商品数据库模型字段，当前的所有model都应该包含如下字段
	Basic auth.MetaModel `json:"basic" bson:"basic"`
	// 菜品编号
	...
	// 会员价
	VipPrice float64 `json:"vip_price" bson:"vip_price"`
	// 所属菜谱
	BelongTo string `json:"belong_to" bson:"belong_to"`
	// 常规分类
